...
var builtSourcePath = '/base/src/';
var builtTestPath = '/base/test/';
...
function isBuiltFile(path) {
  return isJsFile(path) && 
    ((path.substr(0, builtSourcePath.length) == builtSourcePath) || (path.substr(0, builtTestPath.length) == builtTestPath));
}
