/// <reference path="../../typings/pretty-print.d.ts" />
...
import * as lodash from '../../assets/lodash';
...
export class CodeExampleComponent implements OnInit {
    ...
    private getContentPromise(): Observable<string> {
    ...
    private resolveContent() {
        this.getContentPromise().subscribe(content => {
            content = lodash.escape(content);
