import { Directive, Input, ElementRef, Renderer2, SimpleChange, Inject, Host } from "@angular/core";
...
export class SortDirective {
    ...
    private getSortState(): ISortState | null {
    ...
    private onClicked(ev: MouseEvent) {
        ...
        if (sort) {
            sort.predicate = <string>this.predicate;
            sort.order = this.order;
        }
